...
interface TopBarProps {
  ...
  onSidebarModeChange: (mode: 'agents' | 'investigations' | 'analytics') => void;
}
    ...
    <header className="h-12 bg-[#111827] border-b border-[#1f2937] flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-8">
        ...
        <nav className="hidden lg:flex items-center gap-6 ml-4">
          ...
          <a href="#" className="flex items-center justify-center w-8 h-8 rounded-md text-[#9ca3af] hover:bg-[#1f2937] hover:text-white transition-colors" title="Settings/Config: System configuration and preferences">
